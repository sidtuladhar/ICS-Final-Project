...
class GUI:
    ...
    def regUI(self):
        ...
        self.regUI.resizable(width=False,
                             height=False)
        self.regUI.configure(width=400,
                             height=300)
        # create a Label
        self.pls = Label(self.regUI,
        ...
        # create a Label
        self.labelName = Label(self.regUI,
                               text="Name: ",
                               font="Helvetica 12")
        self.labelKey = Label(self.regUI,
                               text="Password: ",
                               font="Helvetica 12")
        ...
        # create a entry box for
        # tyoing the message
        self.entryName = Entry(self.regUI,
                               font="Helvetica 14")
        #password                       
        self.entryKey = Entry(self.regUI,
                               font="Helvetica 14")       
        ...
        # create a Continue Button
        # along with action
        self.reg = Button(self.regUI,
                         text="REGISTER",
                         font="Helvetica 14 bold",
                         command=lambda: self.Register(self.entryName.get(), self.entryKey.get()))
    ...
    def Register(self, name, key):
        if name == "" or key == "":
            ...
            with open('user.csv', 'w', encoding='utf8', newline='') as f:
                dict_writer = csv.DictWriter(f, fieldnames=['users', 'passwords'])
                dict_writer.writerow({'users': name, 'passwords': key})
